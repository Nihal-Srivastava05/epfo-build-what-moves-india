...
/**
 * One dictionary. Tooltips, the glossary page and the assistant all read from
 * here, so they cannot drift apart and start giving different answers.
 */
export const glossary: GlossaryEntry[] = [
  ...
  },
  {
    id: 'form-20',
    term: 'Form 20',
    oneLine: 'The form a nominee files to claim a deceased member’s full PF balance, as a one-time payment.',
    oneLineHi: 'किसी सदस्य की मृत्यु पर उनका पूरा पीएफ़ शेष एकमुश्त लेने के लिए नॉमिनी द्वारा भरा जाने वाला फ़ॉर्म।',
    more: 'It is paid to the registered nominee, or — if none was ever recorded — split among the legal heirs under a succession certificate instead, which is slower.',
    aliases: ['pf death claim', 'nominee claim', 'death settlement'],
    whereYouSeeIt: ['PF Death Claim flow', 'Claim status'],
    audience: ['member'],
  },
  {
    id: 'form-10d',
    term: 'Form 10D',
    oneLine: 'The form a family member files to start drawing a deceased member’s monthly pension.',
    oneLineHi: 'किसी सदस्य की मृत्यु पर उनकी मासिक पेंशन शुरू करने के लिए भरा जाने वाला फ़ॉर्म।',
    more: 'Paid to a spouse, then eligible children, for as long as the scheme allows — a recurring credit, not a one-time payout like Form 20.',
    aliases: ['family pension', 'nominee pension', 'pension death claim'],
    whereYouSeeIt: ['Nominee / Family Pension Claim flow', 'Claim status'],
    audience: ['member', 'pensioner'],
  },
  {
    id: 'cpps',
