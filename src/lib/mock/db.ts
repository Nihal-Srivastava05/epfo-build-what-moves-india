...
export const kycItems: KycItem[] = [
  ...
  { key: 'pan', label: 'PAN', value: 'ABXPS****K', status: 'verified', holder: 'epfo' },
  {
    key: 'bank',
    label: 'Bank account',
    value: 'Punjab National Bank ****4471 · PUNB0234500',
    status: 'attention',
    holder: 'you',
    since: '2026-05-04',
    problem:
    ...
    correctedValue: 'Punjab National Bank ****4471 · PUNB0234501',
  },
...
export const notifications: AppNotification[] = [
  ...
  },
  {
    ...
    body: '₹8,450 was credited to your Bank of Maharashtra account ending 9038 on 01 Aug 2026.',
    official: true,
    aboutType: 'pension',
    aboutId: 'pp-2026-08',
  },
