/** Verbatim port of src/lib/grievances.ts. */
import type { ClaimStage, Grievance, GrievanceRung } from '../data/types.js'
...
export function openGrievances(grievances: readonly Grievance[], personId: string) {
...
export function activeGrievance(grievances: readonly Grievance[], personId: string) {
