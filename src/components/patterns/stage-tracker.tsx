 ...
 *
 * Generic over any stage list — used for both claims and grievances, since
 * both are "an object moving through a fixed sequence of holders" at heart.
 */
export function StageTracker({ stages, className }: { stages: ClaimStage[]; className?: string }) {
